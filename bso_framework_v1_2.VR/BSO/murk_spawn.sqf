...
//		
// Example: nul = [this,"once"] execVM "bso\murk_spawn.sqf"; ---- Will spawn the editor unit once based on the trigger
// Example: nul = [this,"repeated",4,30] execVM "bso\murk_spawn.sqf"; ---- Will spawn the editor unit based on the trigger, then respawn it 4 times with a 30 second delay upon death
// Example: nul = [this,"wave",5,60] execVM "bso\murk_spawn.sqf"; ---- Will spawn the editor unit once based on the trigger, then respawn the entire group (regardless of deaths) 5 times with 60 seconds between
// Example: nul = [this,"reset",5] execVM "bso\murk_spawn.sqf"; ---- Will spawn the editor unit once based on the trigger, then reset the trigger after a preset time (15 seconds default). The unit will be created when trigger is true again, maximum number of lives.
// -----------------------------------------------------------------------------------------------------
// V9 (Murklor again :p) 
